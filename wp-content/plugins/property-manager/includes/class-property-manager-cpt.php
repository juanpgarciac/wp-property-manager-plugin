...
class WP_Property_Manager_CPT extends WP_Property_Manager_Base
{
    public static function register_cpt()
    {
        $labels = array(
            ...
            'archives'              => __( 'Item Archives', WP_PM_DOMAIN ),
            'attributes'            => __( 'Item Attributes', WP_PM_DOMAIN ),
            ...
            'new_item'              => __( 'New Item', WP_PM_DOMAIN ),
            'edit_item'             => __( 'Edit Item', WP_PM_DOMAIN ),
            'update_item'           => __( 'Update Item', WP_PM_DOMAIN ),
            'view_item'             => __( 'View Item', WP_PM_DOMAIN ),
            'view_items'            => __( 'View Items', WP_PM_DOMAIN ),
            'search_items'          => __( 'Search Item', WP_PM_DOMAIN ),
            ...
            'filter_items_list'     => __( 'Filter items list', WP_PM_DOMAIN ),
        );
        $args = array(
